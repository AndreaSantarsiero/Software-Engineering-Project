...
class CannonTest {
    ...
    @BeforeEach
    void setUp() {
        singleCannon = new Cannon(Connector.SINGLE, Connector.DOUBLE, Connector.NONE, Connector.UNIVERSAL, Cannon.Type.SINGLE);
        doubleCannon = new Cannon(Connector.NONE, Connector.SINGLE, Connector.DOUBLE, Connector.UNIVERSAL, Cannon.Type.DOUBLE);
    }
